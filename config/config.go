...
func setConfigDefaults(v *viper.Viper) {
	...
	v.SetDefault("backend.redis.pool.size", 0)
	v.SetDefault("backend.redis.pool.timeout", time.Duration(0))
	v.SetDefault("backend.redis.pool.min_idle_conns", 0)
	v.SetDefault("backend.redis.pool.max_idle_conns", 0)
	v.SetDefault("backend.redis.pool.conn_max_idle_time", time.Duration(0))
	v.SetDefault("backend.redis.pool.conn_max_lifetime", time.Duration(0))
	v.SetDefault("backend.redis.timeouts.dial_timeout", time.Duration(0))
	v.SetDefault("backend.redis.timeouts.read_timeout", time.Duration(0))
	v.SetDefault("backend.redis.timeouts.write_timeout", time.Duration(0))
	v.SetDefault("backend.redis.retry.max_retries", 0)
	v.SetDefault("backend.redis.retry.min_retry_backoff", time.Duration(0))
	v.SetDefault("backend.redis.retry.max_retry_backoff", time.Duration(0))
